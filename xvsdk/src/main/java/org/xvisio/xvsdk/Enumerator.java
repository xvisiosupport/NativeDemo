...
class Enumerator {
    ...
    public Enumerator(Context context, DeviceListener listener) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            context.registerReceiver(mBroadcastReceiver, new IntentFilter(UsbManager.ACTION_USB_DEVICE_ATTACHED),Context.RECEIVER_EXPORTED);
            context.registerReceiver(mBroadcastReceiver, new IntentFilter(UsbManager.ACTION_USB_DEVICE_DETACHED),Context.RECEIVER_EXPORTED);
        } else {
